...
if __name__ == "__main__":
    ...
    # Create a frame with white stroke
    checkbox_frame = tk.Frame(window, highlightbackground="white", highlightthickness=1)
    checkbox_frame.grid(row=0, column=0, columnspan=4, padx=10, pady=10)

    # All faces checkbox
    all_faces = tk.IntVar()
    all_faces_checkbox = tk.Checkbutton(checkbox_frame, anchor="w", relief="groove", activebackground="#2d3436", activeforeground="#74b9ff", selectcolor="black", text="Process all faces in frame", fg="#dfe6e9", borderwidth=0, highlightthickness=0, variable=all_faces, command=toggle_all_faces)
    all_faces_checkbox.grid(row=0, column=0, sticky="w", padx=10, pady=10)

    # FPS limit checkbox
    limit_fps = tk.IntVar(None, not args['keep_fps'])
    fps_checkbox = tk.Checkbutton(checkbox_frame, anchor="w", relief="groove", activebackground="#2d3436", activeforeground="#74b9ff", selectcolor="black", text="Limit FPS to 30", fg="#dfe6e9", borderwidth=0, highlightthickness=0, variable=limit_fps, command=toggle_fps_limit)
    fps_checkbox.grid(row=0, column=1, sticky="w", padx=10, pady=10)

    # Keep frames checkbox
    keep_frames = tk.IntVar(None, args['keep_frames'])
    frames_checkbox = tk.Checkbutton(checkbox_frame, anchor="w", relief="groove", activebackground="#2d3436", activeforeground="#74b9ff", selectcolor="black", text="Keep frames dir", fg="#dfe6e9", borderwidth=0, highlightthickness=0, variable=keep_frames, command=toggle_keep_frames)
    frames_checkbox.grid(row=0, column=2, sticky="w", padx=10, pady=10)
    ...
    start_button.grid(row=0, column=4, sticky="w", padx=10, pady=10)
